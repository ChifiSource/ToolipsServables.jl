...
function bind(f::Function, cm::AbstractComponentModifier, key::String, eventkeys::Symbol ...; on::Symbol = :down, prevent_default::Bool = false)
    eventstr::String = join((" event.$(event)Key && " for event in eventkeys))
    prevent::String = ""
    if prevent_default
...
function bind(f::Function, cm::AbstractComponentModifier, comp::Component{<:Any}, key::String, eventkeys::Symbol ...; on::Symbol = :down, prevent_default::Bool = false)
